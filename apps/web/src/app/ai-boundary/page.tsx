    ...
    <div className="space-y-10 max-w-[1440px] mx-auto pb-16 font-sans">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-[#1D2939] pb-5 font-mono">
        ...
        <div className="flex items-center gap-3 self-start md:self-auto text-xs font-mono">
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-md bg-[#0D121C] border border-[#1D2939] text-[#A7B0C0]">
          ...
          <Link
            href="/dashboard"
            className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-md bg-[#0D121C] hover:bg-[#111827] border border-[#1D2939] text-[#A7B0C0] hover:text-white font-semibold transition-all"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="p-6 rounded-2xl bg-[#0D121C] border border-[#1D2939] space-y-6 font-mono">
            ...
            <div className="space-y-3">
              {/* Step 1: Ingest */}
              <div className="p-3.5 rounded-xl bg-[#080B12] border border-[#1D2939] flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-[#0D121C] text-[#3B82F6] border border-[#3B82F6]/30">01</span>
                  <div>
                    <div className="text-xs font-bold text-white">VENDOR CONFIGURATION</div>
                    <div className="text-[10px] text-[#667085] font-sans">Cisco IOS • Juniper JunOS • Fortinet FortiOS (Raw Text)</div>
                  </div>
                </div>
                <Server className="w-4 h-4 text-[#A7B0C0]" />
              </div>

              {/* Arrow */}
              <div className="text-center text-[#667085] text-xs">↓</div>

              {/* Step 2: Parser & AST */}
              <div className="p-3.5 rounded-xl bg-[#080B12] border border-[#1D2939] flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-[#0D121C] text-[#3B82F6] border border-[#3B82F6]/30">02</span>
                  <div>
                    <div className="text-xs font-bold text-white">PARSER & ABSTRACT SYNTAX TREE (AST)</div>
                    <div className="text-[10px] text-[#667085] font-sans">Lexical tokenization & hierarchical structural extraction</div>
                  </div>
                </div>
                <FileCode2 className="w-4 h-4 text-[#A7B0C0]" />
              </div>
              ...
              <div className="p-3.5 rounded-xl bg-[#080B12] border border-[#3B82F6]/40 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-[#0D121C] text-[#3B82F6] border border-[#3B82F6]/40">03</span>
                  <div>
                    <div className="text-xs font-bold text-[#3B82F6]">UNIVERSAL SECURITY MODEL</div>
                    <div className="text-[10px] text-[#A7B0C0] font-sans">Canonical semantic property representation across vendors</div>
                  </div>
                </div>
              ...
              <div className="p-3.5 rounded-xl bg-[#080B12] border border-[#10B981]/40 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-[10px] text-[#A7B0C0] font-sans">CIS / NIST / STIG / ISO mathematical rule evaluation</div>
                  </div>
                </div>
              ...
              <div className="p-4 rounded-xl bg-[#0D121C] border border-[#1D2939] space-y-2">
                <div className="flex items-center justify-between text-xs">
                  ...
                  <span className="text-[10px] text-[#667085]">SHA-256 Line Evidence</span>
                </div>
                <div className="p-2.5 rounded bg-[#080B12] border border-[#1D2939] text-[11px] text-[#A7B0C0] flex items-center justify-between">
              ...
              <div className="pt-3 border-t border-dashed border-[#1D2939] space-y-3">
                <div className="flex items-center justify-between text-xs text-[#8B5CF6]">
                  <span className="flex items-center gap-1.5 font-bold">
                    <span>↘ READ-ONLY CONTEXT FORK</span>
                  </span>
                  <span className="text-[10px] text-[#667085]">ONE-WAY DATA FLOW</span>
                </div>

                {/* AI Advisory Box */}
                <div className="p-4 rounded-xl bg-[#080B12] border border-[#8B5CF6]/30 space-y-2">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2 text-[#8B5CF6]">
                      <Bot className="w-4 h-4" />
                      <span className="text-xs font-bold uppercase">AI ADVISORY LAYER</span>
                    </div>
                    <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-[#0D121C] text-[#8B5CF6] border border-[#8B5CF6]/30">
                      AUTHORITY: NO
                    </span>
                  </div>
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="p-6 rounded-2xl bg-[#0D121C] border border-[#1D2939] space-y-5 font-mono">
            ...
            <div className="space-y-2">
              <div className="text-[10px] text-[#667085] uppercase font-semibold">SELECT USER QUERY</div>
              <div className="space-y-1.5">
                {SIMULATIONS.map((sim) => (
                  <button
                    ...
                    className={cn(
                      ...
                      selectedSimulation.id === sim.id
                        ? "bg-[#111827] border-[#8B5CF6] text-white"
                  ...
                  >
                    ...
                    <ChevronRight className="w-3.5 h-3.5 text-[#667085] group-hover:text-[#8B5CF6] shrink-0 ml-2" />
                  </button>
                ))}
              </div>
            </div>
            ...
            <div className="space-y-3.5 pt-2 border-t border-[#1D2939]">
              {/* Deterministic Result */}
              <div className="p-3.5 rounded-xl bg-[#080B12] border border-[#EF4444]/30 space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-[10px] font-bold text-[#667085] uppercase">DETERMINISTIC RESULT</span>
                ...
                <div className="p-2 rounded bg-[#0D121C] border border-[#1D2939] text-[11px] space-y-1">
                  <div className="text-[10px] text-[#667085]">Evidence Cited:</div>
                  <code className="text-[#EF4444] font-mono block">
                    Line {selectedSimulation.line}: {selectedSimulation.evidenceSnippet}
                  </code>
                </div>

                <div className="text-[9px] text-[#667085] flex items-center justify-between pt-1 border-t border-[#1D2939]">
              ...
              {/* AI Advisory */}
              <div className="p-4 rounded-xl bg-[#080B12] border border-[#8B5CF6]/30 space-y-2.5">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-1.5 text-xs font-bold text-[#8B5CF6]">
                    <Bot className="w-3.5 h-3.5" />
                    <span>AI ADVISORY EXPLANATION</span>
                  </div>
                  <span className="px-2 py-0.5 rounded text-[9px] font-bold bg-[#0D121C] text-[#8B5CF6] border border-[#8B5CF6]/30">
                ...
                {/* Provenance Box */}
                <div className="p-2.5 rounded bg-[#0D121C] border border-[#1D2939] space-y-1 text-[10px]">
      ...
      <div className="p-6 sm:p-8 rounded-2xl bg-[#0D121C] border border-[#1D2939] space-y-6 font-mono">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="p-5 rounded-xl bg-[#080B12] border border-[#3B82F6]/30 space-y-4">
            <div className="flex items-center justify-between border-b border-[#1D2939] pb-2">
              ...
              <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-[#0D121C] text-[#3B82F6] border border-[#3B82F6]/30">
                AUTHORITY: YES
              </span>
            </div>

            <ul className="space-y-2.5 text-xs text-[#A7B0C0] font-sans">
          ...
          {/* Right: AI Advisory */}
          <div className="p-5 rounded-xl bg-[#080B12] border border-[#8B5CF6]/30 space-y-4">
            <div className="flex items-center justify-between border-b border-[#1D2939] pb-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-6 space-y-4 font-mono">
          ...
          <div className="p-5 rounded-xl bg-[#0D121C] border border-[#EF4444]/30 space-y-3">
            <div className="text-xs font-bold text-[#EF4444]">STRICT PRODUCT INVARIANTS:</div>
            <ul className="space-y-2 text-xs text-[#A7B0C0] font-mono">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-6 space-y-4 font-mono">
          <div className="flex items-center justify-between border-b border-[#1D2939] pb-2">
            ...
            <span className="text-[10px] text-[#667085]">Deterministic Ledger</span>
          </div>
          ...
          <div className="space-y-2 text-xs">
            {[
              ...
              <div
                key={idx}
                className="p-2.5 rounded-lg bg-[#0D121C] border border-[#1D2939] flex items-center justify-between"
              >
                <div className="flex items-center gap-2.5">
                  <span className="text-[10px] text-[#667085]">{ev.time}</span>
                  <span className="font-semibold text-white">{ev.event}</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-[10px] text-[#A7B0C0]">{ev.detail}</span>
