...
export default function SecurityTimeMachinePage() {
  ...
  return (
    <div className="space-y-6 pb-16">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-[#1F1F1F] pb-5 font-mono">
        <div>
          <div className="flex items-center gap-3">
            <div className="p-2.5 bg-[#0B0B0B] border border-[#1F1F1F] rounded-xl text-[#3B82F6]">
              <History className="h-6 w-6" />
            </div>
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-2xl font-bold text-[#F2F2F2] tracking-tight font-sans">SECURITY TIME MACHINE</h1>
                <span className="px-2 py-0.5 text-[10px] font-mono uppercase tracking-wider bg-[#0B0B0B] text-[#3B82F6] border border-[#3B82F6]/30 rounded font-bold">
                  v2.0 DELTA ENGINE
                </span>
        ...
        <div className="flex items-center gap-3">
          {pairs.length > 0 && (
            <div className="flex items-center gap-2">
              <span className="text-xs text-[#636366] font-mono">Evolution Presets:</span>
              <select
                value={selectedPairKey}
                onChange={(e) => handlePairChange(e.target.value)}
                className="bg-[#0B0B0B] border border-[#1F1F1F] text-xs text-[#8E8E93] rounded-lg px-3 py-1.5 focus:outline-none focus:border-[#3B82F6]"
              >
      ...
      {/* Audit Selection Bar */}
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center bg-[#0B0B0B] border border-[#1F1F1F] rounded-xl p-4">
        {/* BEFORE Selector */}
        <div className="md:col-span-5 space-y-1.5">
          <label className="text-[11px] font-mono uppercase tracking-wider text-[#636366] flex items-center gap-1.5">
          ...
          <select
            ...
            className="w-full bg-[#080808] border border-[#1F1F1F] text-xs text-[#8E8E93] rounded-lg p-2.5 focus:outline-none focus:border-[#3B82F6] font-mono"
          >
        ...
        <div className="md:col-span-2 flex flex-col items-center justify-center pt-2">
          <div className="p-2 rounded-full bg-[#080808] border border-[#1F1F1F] text-[#3B82F6]">
            <ArrowRight className="h-5 w-5" />
          </div>
          <span className="text-[10px] font-mono uppercase text-[#636366] mt-1">Re-Analysis</span>
        </div>
      ...
      {audits.length < 2 && !auditsLoading && (
        <div className="p-8 rounded-xl bg-[#0B0B0B] border border-[#1F1F1F] text-center space-y-3 font-mono">
          ...
          <div>
            <div className="text-xs font-bold text-[#F2F2F2] uppercase tracking-wider">HISTORICAL COMPARISON UNAVAILABLE</div>
            <p className="text-xs text-[#636366] mt-1 max-w-md mx-auto">
          ...
          <Link
            ...
            className="inline-block px-3.5 py-1.5 rounded bg-[#141414] hover:bg-[#151E2D] text-[#3B82F6] border border-[#3B82F6]/40 text-xs font-semibold"
          >
      ...
      {comparisonLoading && (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 animate-pulse">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="h-28 bg-[#0B0B0B] border border-[#1F1F1F] rounded-xl" />
          ))}
        </div>
      )}
      ...
      {comparison && deltas && (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 font-mono">
          ...
          <div className="bg-[#0B0B0B] border border-[#1F1F1F] rounded-xl p-4 relative overflow-hidden">
            <div className="flex items-center justify-between">
              <span className="text-xs font-mono uppercase text-[#636366]">Compliance Posture</span>
              <ShieldCheck className="h-4 w-4 text-[#3B82F6]" />
            </div>
            <div className="flex items-baseline gap-2 mt-2">
              <span className="text-lg font-mono text-[#636366] line-through">
                {deltas.before_score.toFixed(1)}%
              </span>
              <ArrowRight className="h-3.5 w-3.5 text-[#636366]" />
            ...
            <div className="mt-2 flex items-center gap-2">
              ...
              <span className="text-[11px] text-[#636366]">Deterministic Delta</span>
            </div>
          </div>
          ...
          <div className="bg-[#0B0B0B] border border-[#1F1F1F] rounded-xl p-4 relative overflow-hidden">
            <div className="flex items-center justify-between">
              <span className="text-xs font-mono uppercase text-[#636366]">Risk Score</span>
            ...
            <div className="mt-2 flex items-center gap-2">
              ...
              <span className="text-[11px] text-[#636366]">Total Fleet Risk</span>
            </div>
          </div>
          ...
          <div className="bg-[#0B0B0B] border border-[#1F1F1F] rounded-xl p-4 relative overflow-hidden">
            <div className="flex items-center justify-between">
              <span className="text-xs font-mono uppercase text-[#636366]">Failed Controls</span>
          ...
          <div className="bg-[#0B0B0B] border border-[#1F1F1F] rounded-xl p-4 relative overflow-hidden">
            <div className="flex items-center justify-between">
              <span className="text-xs font-mono uppercase text-[#636366]">P0 / Critical Risks</span>
            ...
            <div className="mt-2 flex items-center gap-2">
              ...
              <span className="text-[11px] text-[#636366]">Posture Quality</span>
            </div>
          </div>
        </div>
      )}
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-1">
          <button
            ...
            className={cn(
              ...
              activeTab === "diff"
                ? "bg-[#0B0B0B] text-[#3B82F6] border border-[#3B82F6]/40 shadow-sm"
                : "text-[#636366] hover:text-white hover:bg-[#0B0B0B]"
            )}
          >
      ...
      {activeTab === "diff" && comparison && (
        <div className="space-y-3 font-mono">
          <div className="flex items-center justify-between text-xs text-[#636366] px-1">
          ...
          <div className="border border-[#1F1F1F] rounded-xl overflow-hidden bg-[#080808] font-mono text-xs shadow-2xl">
            {/* Diff Header */}
            <div className="grid grid-cols-2 bg-[#0B0B0B] border-b border-[#1F1F1F] py-2 px-4 text-[11px] text-[#636366] font-semibold tracking-wider uppercase">
              <div className="flex items-center justify-between pr-4 border-r border-[#1F1F1F]">
                <span>BASELINE CONFIGURATION (BEFORE)</span>
                <span className="text-[#636366] text-[10px]">{comparison.device_name}</span>
              </div>
            ...
            {/* Side-by-side lines */}
            <div className="max-h-[600px] overflow-y-auto divide-y divide-[#1F1F1F]/40">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-start border-r border-[#1F1F1F] pr-2 py-1">
                      <span className="w-12 text-right pr-3 select-none text-[#636366] text-[11px]">
                        ...
                        {hasControls && line.content_before && (
                          <div className="inline-flex gap-1 ml-2">
                            {line.associated_control_ids.map((cid) => (
                              <span
                                key={cid}
                                className="text-[9px] px-1 py-0.2 rounded bg-[#0B0B0B] text-[#3B82F6] border border-[#3B82F6]/40 font-mono"
                              >
                                {cid}
                              </span>
                            ))}
      ...
      {activeTab === "transitions" && comparison && (
        <div className="space-y-4 font-mono">
          {/* Filters & Search */}
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-[#0B0B0B] border border-[#1F1F1F] p-3 rounded-xl">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    transitionFilter === f.id
                      ? "bg-[#080808] text-[#3B82F6] border border-[#3B82F6]/40"
                      : "text-[#636366] hover:text-white hover:bg-[#080808]"
                  )}
                >
                  <span>{f.label}</span>
                  <span className="text-[10px] px-1.5 py-0.2 rounded-full bg-[#0B0B0B] border border-[#1F1F1F] font-mono">
                    {f.count}
                  </span>
                </button>
              ))}
            ...
            <div className="relative w-full sm:w-64">
              ...
              <input
                ...
                className="w-full bg-[#080808] border border-[#1F1F1F] rounded-lg pl-9 pr-3 py-1.5 text-xs text-white placeholder-[#636366] focus:outline-none focus:border-[#3B82F6]"
              />
            </div>
          </div>

          {/* Transition Table */}
          <div className="border border-[#1F1F1F] rounded-xl overflow-hidden bg-[#080808] shadow-xl">
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs font-mono">
                <thead className="bg-[#0B0B0B] border-b border-[#1F1F1F] text-[11px] text-[#636366] uppercase tracking-wider">
                  <tr>
                  ...
                  {filteredTransitions.map((item) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="py-3 px-3 text-[#636366]">{item.framework}</td>
                        <td className="py-3 px-3">
                          <span
                            className={cn(
                              ...
                              item.severity === "LOW" && "bg-[#636366]/20 text-[#8E8E93] border border-[#636366]/30"
                            )}
                          >
                            {item.severity}
                          </span>
                        ...
                        <td className="py-3 px-3">
                          <span
                            className={cn(
                              ...
                              item.before_status !== "PASS" && item.before_status !== "FAIL" && "bg-[#0B0B0B] text-[#636366]"
                            )}
                          >
                            {item.before_status}
                          </span>
                        ...
                        <td className="py-3 px-3">
                          <span
                            className={cn(
                              ...
                              item.after_status !== "PASS" && item.after_status !== "FAIL" && "bg-[#0B0B0B] text-[#636366]"
                            )}
                          >
                            {item.after_status}
                          </span>
                        ...
                        <td className="py-3 px-3">
                          ...
                          {isUnchangedFail && (
                            <span className="text-[#636366] bg-[#0B0B0B] border border-[#1F1F1F] px-2 py-0.5 rounded text-[10px]">
                              UNCHANGED (FAIL)
                            </span>
                          )}
                        ...
                        <td className="py-3 px-4 max-w-md">
                          ...
                          <p className="text-[#636366] text-[11px] font-mono mt-0.5 truncate">
                            {item.explanation}
                          </p>
                        </td>
                        <td className="py-3 px-3 text-right">
                          <ChevronRight
                            className={cn(
                              "h-4 w-4 text-[#636366] inline-block transition-transform",
          ...
          {selectedTransition && (
            <div className="bg-[#0B0B0B] border border-[#3B82F6]/40 rounded-xl p-5 space-y-4 shadow-2xl animate-in fade-in duration-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 font-mono text-xs">
                ...
                <div className="bg-[#080808] border border-[#1F1F1F] rounded-lg p-3.5 space-y-2">
                  ...
                  <pre className="bg-[#0B0B0B] p-2.5 rounded border border-[#1F1F1F] text-[#EF4444] overflow-x-auto text-[11px]">
                ...
                <div className="bg-[#080808] border border-[#1F1F1F] rounded-lg p-3.5 space-y-2">
                  ...
                  <pre className="bg-[#0B0B0B] p-2.5 rounded border border-[#1F1F1F] text-[#10B981] overflow-x-auto text-[11px]">
              ...
              {selectedTransition.remediation_applied && (
                <div className="bg-[#080808] border border-[#10B981]/30 rounded-lg p-3.5 space-y-2 font-mono text-xs">
                  <div className="flex items-center justify-between text-[#10B981] font-bold text-[11px] uppercase">
                    ...
                    <span className="text-[10px] text-[#636366]">Read-Only Advisory</span>
                  </div>
                  <pre className="bg-[#0B0B0B] p-2.5 rounded border border-[#1F1F1F] text-[#10B981] overflow-x-auto text-[11px]">
                    {selectedTransition.remediation_applied}
                  </pre>
          ...
          <div className="bg-[#0B0B0B] border border-[#1F1F1F] rounded-xl p-5 space-y-4">
            ...
            <div className="space-y-4 pt-2">
              <div>
                ...
                <div className="w-full bg-[#080808] rounded-full h-3 overflow-hidden border border-[#1F1F1F]">
                  <div
            ...
            <div className="bg-[#080808] border border-[#1F1F1F] rounded-lg p-3 text-xs text-[#8E8E93] font-mono mt-4">
            ...
            <div className="space-y-3 pt-2 font-mono text-xs">
              {(
                [
                  ...
                  { label: "P3 (Low)", before: deltas.before_priority_counts.p3, after: deltas.after_priority_counts.p3, color: "text-[#636366]" },
                ] as const
              ).map((p) => {
                ...
                return (
                  <div key={p.label} className="bg-[#080808] border border-[#1F1F1F] rounded-lg p-2.5 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                      <span className="text-[#636366]">{p.before}</span>
      ...
      {activeTab === "timeline" && comparison && (
        <div className="bg-[#0B0B0B] border border-[#1F1F1F] rounded-xl p-6 space-y-6">
          <div>
            ...
            <p className="text-xs text-[#636366] mt-1 font-sans">
              Git-style chronological trace of configuration state, audit evaluations, and verified remediations.
            </p>
          </div>

          <div className="relative pl-6 space-y-8 before:absolute before:left-2.5 before:top-2 before:bottom-2 before:w-0.5 before:bg-[#1F1F1F]">
            {comparison.timeline.map((evt, idx) => (
              <div key={evt.id || idx} className="relative group">
                {/* Dot */}
                <div className="absolute -left-6 top-1 w-5 h-5 rounded-full bg-[#080808] border-2 border-[#3B82F6] flex items-center justify-center">
                  <div className="w-2 h-2 rounded-full bg-[#3B82F6]" />
                </div>

                <div className="bg-[#080808] border border-[#1F1F1F] rounded-xl p-4 space-y-2 hover:border-[#3B82F6]/40 transition-colors font-mono text-xs">
                  <div className="flex items-center justify-between flex-wrap gap-2">
                    <div className="flex items-center gap-2">
                      ...
                      {evt.badge && (
                        <span className="px-2 py-0.5 bg-[#0B0B0B] text-[#3B82F6] text-[10px] font-mono rounded border border-[#3B82F6]/30">
                          {evt.badge}
                        </span>
                      )}
                    </div>
                  ...
                  <p className="text-xs text-[#8E8E93] font-sans">{evt.description}</p>

                  {(evt.configuration_hash || evt.audit_id) && (
                    <div className="flex items-center gap-4 text-[10px] font-mono text-[#636366] pt-1 border-t border-[#1F1F1F]">
      ...
      {activeTab === "traceability" && comparison && (
        <div className="bg-[#0B0B0B] border border-[#1F1F1F] rounded-xl p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-3 text-xs font-mono">
            {/* Step 1 */}
            <div className="bg-[#080808] border border-[#1F1F1F] rounded-xl p-4 space-y-2">
            ...
            {/* Step 5 */}
            <div className="bg-[#080808] border border-[#10B981]/40 rounded-xl p-4 space-y-2 bg-[#10B981]/5">
          ...
          <div className="border border-[#1F1F1F] rounded-xl overflow-hidden bg-[#080808]">
                  ...
                  <div key={t.control_id} className="p-4 space-y-3 font-mono text-xs">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-[11px]">
                      <div className="bg-[#0B0B0B] p-2.5 rounded border border-[#EF4444]/20 text-[#EF4444]">
                        <span className="block text-[10px] text-[#636366] uppercase font-bold mb-1">Baseline Token</span>
                        <code>{t.before_evidence || "Insecure default"}</code>
                      </div>
                      <div className="bg-[#0B0B0B] p-2.5 rounded border border-[#10B981]/20 text-[#10B981]">
                        <span className="block text-[10px] text-[#636366] uppercase font-bold mb-1">Hardened Token</span>
                    ...
                    {t.remediation_applied && (
                      <div className="bg-[#0B0B0B] p-2.5 rounded border border-[#1F1F1F] text-[#8E8E93] text-[11px]">
                        <span className="block text-[10px] text-[#636366] uppercase font-bold mb-1">Allowlisted Directive</span>
