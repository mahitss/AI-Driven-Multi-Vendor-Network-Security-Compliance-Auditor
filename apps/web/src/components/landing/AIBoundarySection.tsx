...
export default function AIBoundarySection() {
  return (
    <section id="ai-boundary" className="py-20 px-4 sm:px-6 max-w-7xl mx-auto border-t border-[#1F1F1F] font-sans">
      {/* Central Axiom Banner */}
      <div className="p-8 sm:p-12 rounded-2xl bg-[#0B0B0B] border border-[#1F1F1F] text-center space-y-4 mb-16 shadow-sm">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#141414] border border-[#1F1F1F] text-[11px] font-mono text-[#3B82F6]">
          <Lock className="w-3.5 h-3.5" />
          <span>STRICT ARCHITECTURAL INVARIANT</span>
        </div>
        <h2 className="text-3xl sm:text-5xl font-extrabold text-[#F2F2F2] tracking-tight font-sans">
          AI INTERPRETS. <span className="text-[#3B82F6]">RULES DECIDE.</span> HUMANS CONTROL.
        </h2>
        <p className="text-xs sm:text-sm text-[#8E8E93] max-w-2xl mx-auto leading-relaxed">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 font-mono">
        ...
        <div className="p-6 sm:p-8 rounded-xl bg-[#0B0B0B] border border-[#10B981]/30 space-y-6">
          ...
          <div className="space-y-3 text-xs text-[#8E8E93] font-sans">
        ...
        {/* AI Advisory Gateway */}
        <div className="p-6 sm:p-8 rounded-xl bg-[#0B0B0B] border border-[#8B5CF6]/30 space-y-6">
          <div className="flex items-center gap-3">
          ...
          <div className="space-y-3 text-xs text-[#8E8E93] font-sans">
            ...
            <div className="flex items-start gap-2.5 text-[#636366]">
              <Check className="w-4 h-4 text-[#636366] shrink-0 mt-0.5" />
