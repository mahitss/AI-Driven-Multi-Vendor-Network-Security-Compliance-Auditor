...
export default function LandingHero() {
  return (
    <section className="relative min-h-[800px] lg:h-[calc(100vh-56px)] xl:min-h-[840px] flex items-center pl-6 sm:pl-10 lg:pl-16 pr-4 sm:pr-8 lg:pr-10 pt-16 pb-10 overflow-hidden bg-[#03070C] text-[#FFFFFF]">
      {/* 1. Atmospheric Ambient Peripheral Telemetry */}
      <TelemetryBackground />

      {/* 2. Strict 2-Column Hero Grid: ~38% Left / ~62% Right */}
      <div className="w-full max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-[38%_62%] items-center gap-6 lg:gap-8 relative z-10">
        ...
        <div className="w-full max-w-[520px] flex flex-col items-start text-left z-20">
          ...
          {/* Clean Controlled Editorial Headline (Zero-Collision Spans, Exact Reference Typography) */}
          ...
          {/* Action Controls - Mathematically Aligned 44px Height */}
