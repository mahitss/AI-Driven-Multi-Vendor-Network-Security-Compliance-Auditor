...
export default function LandingHero() {
  return (
    <section className="relative min-h-[780px] lg:h-[calc(100vh-56px)] xl:min-h-[820px] flex items-center pl-6 sm:pl-10 lg:pl-16 pr-4 sm:pr-8 lg:pr-8 pt-14 pb-8 overflow-hidden bg-[#03070C] text-[#FFFFFF]">
      ...
      {/* 3. Left Content: Clean Compact Editorial Security Messaging (Z-20, Max 460px) */}
      <div className="relative z-20 w-full max-w-[460px] lg:max-w-[480px] flex flex-col items-start text-left">
        ...
        {/* Supporting Architectural Copy (Max 440px Container) */}
        <p className="max-w-[440px] text-[14px] sm:text-[15px] text-[#8B9EB3] leading-[1.55] font-sans font-normal mb-8">
      ...
      <div className="hidden lg:flex absolute bottom-4 left-6 sm:left-10 z-20 items-center justify-center w-8 h-8 rounded-full bg-[#0B132B]/80 border border-white/[0.08] text-[#8B9EB3] text-[11px] font-mono">
        N
      </div>
    </section>
  );
