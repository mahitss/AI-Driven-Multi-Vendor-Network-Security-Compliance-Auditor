...
export default function GoldenDemoCalloutSection() {
  return (
    <section id="security-intelligence" className="py-16 px-4 sm:px-6 max-w-[1440px] mx-auto font-sans">
      <div className="p-8 sm:p-12 rounded-2xl bg-[#0B0B0B] border border-[#1F1F1F] shadow-sm flex flex-col lg:flex-row items-center justify-between gap-8">
        <div className="space-y-4 max-w-2xl">
          ...
          <p className="text-xs sm:text-sm text-[#8E8E93] font-mono">
            Canonical Gateway Baseline: <span className="text-[#F2F2F2]">cisco-core-router.cfg</span> (52 lines • SHA-256 Verified)
          </p>

          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-2 text-[11px] font-mono text-[#8E8E93]">
        ...
        <div className="flex flex-col sm:flex-row lg:flex-col gap-3.5 w-full lg:w-auto font-mono text-xs">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-lg bg-[#141414] border border-[#1F1F1F] hover:border-[#2C2C2E] text-[#F2F2F2] font-semibold transition-all"
          >
