  ...
  return (
    <section id="ai-boundary" className="py-20 px-4 sm:px-6 max-w-[1440px] mx-auto space-y-12 font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 font-mono text-xs">
        ...
        <div className="p-6 rounded-xl bg-[#0E131F]/90 border border-[#10B981]/40 space-y-5 shadow-[0_0_24px_rgba(16,185,129,0.06)]">
          ...
          <div className="p-4 rounded-lg bg-[#07090E] border border-white/5 space-y-3">
            <div className="flex items-center justify-between">
              <div>
                <span className="text-[10px] text-[#737373]">CONTROL ID</span>
                <div className="text-sm font-bold text-white">CIS-1.2.1 (SSH Version)</div>
              </div>
            ...
            <div className="space-y-1 text-[11px]">
              <div className="text-[10px] text-[#737373]">LINE-LEVEL EVIDENCE</div>
              <div className="p-2 rounded bg-black/40 border border-[#EF4444]/20 text-[#EF4444] font-mono flex items-center justify-between">
                ...
                <span className="text-[10px] text-[#737373]">Expected: 2</span>
              </div>
            </div>
        ...
        {/* Right Column: Grounded AI Advisory (Cyan) */}
        <div className="p-6 rounded-xl bg-[#0E131F]/90 border border-[#06B6D4]/40 space-y-5 shadow-[0_0_24px_rgba(6,182,212,0.06)]">
          <div className="flex items-center justify-between pb-3 border-b border-white/5">
            <div className="flex items-center gap-2">
            ...
            <span className="px-2 py-0.5 rounded bg-[#06B6D4]/10 text-[#06B6D4] font-bold text-[10px] border border-[#06B6D4]/30">
              AI ≠ VERDICT
            </span>
          </div>
          ...
          <div className="p-4 rounded-lg bg-[#07090E] border border-white/5 space-y-3">
            <div className="flex items-center justify-between text-[10px]">
              <span className="text-[#06B6D4] font-bold">WHY THIS MATTERS</span>
              <span className="text-[#737373]">READ ONLY • EVIDENCE GROUNDED</span>
            </div>

            <p className="text-[11px] text-[#D4D4D4] font-sans leading-relaxed bg-black/40 p-2.5 rounded border border-white/5">
            ...
            <div className="pt-2 flex items-center gap-4 text-[10px] text-[#06B6D4]">
              <span className="flex items-center gap-1">
